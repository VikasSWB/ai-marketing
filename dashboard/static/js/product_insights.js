...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ### NEW DATE RANGE HIDE 
    const dateRangeOptionSelect = document.getElementById('dateRangeOption');
    const customDateRangeContainer = document.getElementById('customDateRange');

    if (dateRangeOptionSelect && customDateRangeContainer) {
    dateRangeOptionSelect.addEventListener('change', () => {
        if (dateRangeOptionSelect.value === 'custom') {
