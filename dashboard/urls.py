...
urlpatterns = [
   ...
   path('financial_insights/', views.financial_insights, name='financial_insights'),
    ...
    # path('debug-cache/', views.debug_cache_keys, name='debug_cache_keys'),

    ###AD ###
    path('submit_meta_form/', views.submit_meta_form, name='submit_meta_form'),
    # path('privacy-policy/', views.privacy_policy, name='privacy_policy'),
    path('submit_google_form/', views.submit_google_form, name='submit_google_form'),
